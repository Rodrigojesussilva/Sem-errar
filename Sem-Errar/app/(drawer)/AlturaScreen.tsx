...
export default function AlturaScreen() {
  ...
  const alturasPredefinidas = [
    {
      id: '155-160',
      title: '155-160 cm',
      subtitle: 'Baixa estatura',
      icon: 'arrow-down',
      color: '#8E44AD',
    },
    {
      ...
      >
        <View style={styles.mainContainer}>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.alturasContainer}>
              <Text style={styles.alturasTitle}>Selecione uma faixa de altura:</Text>
              
              <View style={styles.alturasGrid}>
                {alturasPredefinidas.map((altura) => (
                  <Pressable
                    key={altura.id}
                    style={[
                      styles.alturaItem,
                      alturaCm === altura.id.split('-')[0] && styles.alturaItemSelecionado
                    ]}
                    onPress={() => {
                      setUnidadeSelecionada('cm');
                      setAlturaCm(altura.id.split('-')[0]);
                    }}
                  >
                    <View style={[
                      styles.alturaIconContainer,
                      { backgroundColor: `${altura.color}15` }
                    ]}>
                      <FontAwesome name={altura.icon as any} size={22} color={altura.color} />
                    </View>
                    
                    <View style={styles.alturaContent}>
                      <Text style={[
                        styles.alturaTitulo,
                        alturaCm === altura.id.split('-')[0] && styles.alturaTituloSelecionado
                      ]}>
                        {altura.title}
                      </Text>
                      <Text style={styles.alturaSubtitulo}>{altura.subtitle}</Text>
                    </View>
                    
                    <View style={[
                      styles.radioButton,
                      alturaCm === altura.id.split('-')[0] && styles.radioButtonSelecionado
                    ]}>
                      {alturaCm === altura.id.split('-')[0] && (
